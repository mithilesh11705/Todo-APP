...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        // UI improvement: update welcome text color dynamically
        mainBinding.welcomeTxt.setTextColor(resources.getColor(android.R.color.holo_blue_dark))

        // UI improvement: update Add Task button style
        mainBinding.addTaskFABtn.setBackgroundColor(resources.getColor(android.R.color.holo_blue_dark))
       // mainBinding.addTaskFABtn.setTextColor(resources.getColor(android.R.color.white))
    ...
    private fun setupListGridToggle() {
        isListMutableLiveData.observe(this) { isList ->
            if (isList) {
    ...
    private fun callSortByDialog() {
        var checkedItem = 0   // 0 is default item set
    ...
    private fun callGetTaskList() {
        val taskRecyclerViewAdapter = mainBinding.taskRV.adapter as TaskRVVBListAdapter
